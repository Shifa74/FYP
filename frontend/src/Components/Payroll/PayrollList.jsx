...
const PayrollList = () => {
  ...
  const payrollData = [
    { id: 1, name: 'M SHAHRIYAR', grade: 'A', date: '2023-07-01', time: '10:00 AM', salary: '$3000', status: 'Paid' },
    { id: 2, name: 'M ALI', grade: 'B', date: '2023-07-02', time: '11:00 AM', salary: '$2500', status: 'Pending' },
    { id: 3, name: 'EMAN FATIMA', grade: 'A', date: '2023-07-03', time: '12:00 PM', salary: '$4000', status: 'Paid' },
    { id: 3, name: 'EMAN FATIMA', grade: 'A', date: '2023-07-03', time: '12:00 PM', salary: '$4000', status: 'Paid' },
        { id: 3, name: 'EMAN FATIMA', grade: 'A', date: '2023-07-03', time: '12:00 PM', salary: '$4000', status: 'Paid' }
